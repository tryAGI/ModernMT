...
{
    private const string UserSecretsId = "ModernMT.CLI";
    private const string UserSecretApiKeyName = "MODERNMT_API_KEY";
    private static readonly string[] ApiKeyEnvironmentVariables = [@"MODERNMT_API_KEY"];
    private const string CredentialFileDirectoryName = ".modern-mt";

    public static async global::System.Threading.Tasks.Task<global::ModernMT.ModernMTClient> CreateClientAsync(ParseResult parseResult, CancellationToken cancellationToken = default)
    {
        ...
        var authorizations = string.IsNullOrWhiteSpace(apiKey)
            ? new global::System.Collections.Generic.List<global::ModernMT.EndPointAuthorization>()
            : new global::System.Collections.Generic.List<global::ModernMT.EndPointAuthorization>
            {
        CreateAuthorization(
            type: "ApiKey",
        ...
        return new global::ModernMT.ModernMTClient(
            httpClient: null,
            baseUri: baseUri,
    ...
    private static global::ModernMT.EndPointAuthorization CreateAuthorization(
        string type,
        string schemeId,
        string location,
        string name,
        string value)
    {
        var authorization = new global::ModernMT.EndPointAuthorization
        {
            Type = type,
            Location = location,
            Name = name,
        ...
        var schemeIdProperty = typeof(global::ModernMT.EndPointAuthorization).GetProperty("SchemeId");
    ...
    public static async global::System.Threading.Tasks.Task<int> RunAsync(Func<global::System.Threading.Tasks.Task> action, CancellationToken cancellationToken = default)
    {
        ...
        catch (global::ModernMT.ApiException exception)
        {
    ...
    private static Uri? ResolveBaseUri(ParseResult parseResult)
    {
        ...
        {
            baseUrl = Environment.GetEnvironmentVariable("MODERNMT_BASE_URL");
        }
    ...
    private static async global::System.Threading.Tasks.Task WriteApiExceptionAsync(global::ModernMT.ApiException exception)
    {
        var builder = new StringBuilder();
