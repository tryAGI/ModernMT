...
internal static partial class AddContentCommandApiCommand
{
    ...
    private static Option<string?> Session { get; } = new(
        name: @"--session")
    {
        Description = @"",
    };
    ...
    public static Command Create()
    {
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            ...
            {
                        var __requestBase = await CliRuntime.ReadRequestOrDefaultAsync<global::ModernMT.AddContentRequest>(
                            parseResult,
                            Input,
                            RequestJson,
                            RequestFile,
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.AddContentAsync(
                                    id: id,
                                    source: source,
                                    target: target,
                                    sentence: sentence,
