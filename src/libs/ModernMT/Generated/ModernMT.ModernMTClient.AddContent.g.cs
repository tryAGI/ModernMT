...
namespace ModernMT
{
    public partial class ModernMTClient
    {
        ...
        {
            var __response = await AddContentAsResponseAsync(
                id: id,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::ModernMT.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::ModernMT.AutoSDKHttpResponse<global::ModernMT.ImportJobResponse>> AddContentAsResponseAsync(
            int id,
