...
namespace ModernMT
{
    public partial class ModernMTClient
    {
        ...
        {
            var __response = await GetContextVectorAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::ModernMT.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::ModernMT.AutoSDKHttpResponse<global::ModernMT.ContextVectorResponse>> GetContextVectorAsResponseAsync(
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::ModernMT.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::ModernMT.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GetContextVector",
                                methodName: "GetContextVectorAsync",
                                pathTemplate: "\"/context-vector\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                    ...
                    await global::ModernMT.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::ModernMT.ContextVectorResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::ModernMT.AutoSDKHttpResponse<global::ModernMT.ContextVectorResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::ModernMT.ContextVectorResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
