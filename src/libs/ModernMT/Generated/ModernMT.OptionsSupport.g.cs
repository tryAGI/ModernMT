...
namespace ModernMT
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::ModernMT.AutoSDKRetryOptions Retry { get; set; } = new global::ModernMT.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::ModernMT.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::ModernMT.IAutoSDKHook>();
        ...
        public global::ModernMT.AutoSDKClientOptions AddHook(
            global::ModernMT.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::ModernMT.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::ModernMT.AutoSDKClientOptions UseAuthorizationProvider(
            global::ModernMT.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::ModernMT.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::ModernMT.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::ModernMT.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::ModernMT.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::ModernMT.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::ModernMT.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::ModernMT.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::ModernMT.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::ModernMT.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::ModernMT.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::ModernMT.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::ModernMT.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::ModernMT.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::ModernMT.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::ModernMT.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::ModernMT.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
            ...
            global::ModernMT.AutoSDKClientOptions clientOptions,
            global::ModernMT.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::ModernMT.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::ModernMT.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::ModernMT.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::ModernMT.AutoSDKClientOptions clientOptions,
            global::System.Func<global::ModernMT.IAutoSDKHook, global::ModernMT.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::ModernMT.AutoSDKHookContext context)
        {
