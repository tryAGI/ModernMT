...
namespace ModernMT
{
    public partial class ModernMTClient
    {
        ...
        private static readonly global::ModernMT.EndPointSecurityRequirement s_TranslateBatchSecurityRequirement0 =
        ...
        private static readonly global::ModernMT.EndPointSecurityRequirement[] s_TranslateBatchSecurityRequirements =
            new global::ModernMT.EndPointSecurityRequirement[]
            {                s_TranslateBatchSecurityRequirement0,
            };
        partial void PrepareTranslateBatchArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::ModernMT.BatchTranslateRequest request);
        partial void PrepareTranslateBatchRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::ModernMT.BatchTranslateRequest request);
        partial void ProcessTranslateBatchResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessTranslateBatchResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::ModernMT.BatchTranslateResponse> TranslateBatchAsync(

            global::ModernMT.BatchTranslateRequest request,
            global::ModernMT.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await TranslateBatchAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::ModernMT.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::ModernMT.AutoSDKHttpResponse<global::ModernMT.BatchTranslateResponse>> TranslateBatchAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareTranslateBatchArguments(
            ...
            var __authorizations = global::ModernMT.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_TranslateBatchSecurityRequirements,
                operationName: "TranslateBatchAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::ModernMT.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::ModernMT.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "TranslateBatchAsync",
                                pathTemplate: "\"/translate/batch\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                cancellationToken: __effectiveCancellationToken).ConfigureAwait(false);
                    ...
                    {
                        var __retryDelay = global::ModernMT.AutoSDKRequestOptionsSupport.GetRetryDelay(
                            clientOptions: Options,
                            requestOptions: requestOptions,
                            response: null,
                            attempt: __attempt);
                ...
                else
                {
                    await global::ModernMT.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessTranslateBatchResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::ModernMT.BatchTranslateResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::ModernMT.AutoSDKHttpResponse<global::ModernMT.BatchTranslateResponse>(
                                        statusCode: __response.StatusCode,
                                        headers: global::ModernMT.AutoSDKHttpResponse.CreateHeaders(__response),
                                        requestUri: __response.RequestMessage?.RequestUri,
                                        body: __value);
                                }
                                catch (global::System.Exception __ex)
                                {
                                    throw global::ModernMT.ApiException.Create(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::ModernMT.BatchTranslateResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
