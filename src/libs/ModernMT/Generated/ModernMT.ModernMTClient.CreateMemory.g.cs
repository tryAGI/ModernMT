...
namespace ModernMT
{
    public partial class ModernMTClient
    {
        ...
        private static readonly global::ModernMT.EndPointSecurityRequirement s_CreateMemorySecurityRequirement0 =
        ...
        private static readonly global::ModernMT.EndPointSecurityRequirement[] s_CreateMemorySecurityRequirements =
            new global::ModernMT.EndPointSecurityRequirement[]
            {                s_CreateMemorySecurityRequirement0,
            };
        partial void PrepareCreateMemoryArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::ModernMT.CreateMemoryRequest request);
        partial void PrepareCreateMemoryRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::ModernMT.CreateMemoryRequest request);
        partial void ProcessCreateMemoryResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCreateMemoryResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::ModernMT.MemoryResponse> CreateMemoryAsync(

            global::ModernMT.CreateMemoryRequest request,
            global::ModernMT.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await CreateMemoryAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::ModernMT.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::ModernMT.AutoSDKHttpResponse<global::ModernMT.MemoryResponse>> CreateMemoryAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::ModernMT.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateMemorySecurityRequirements,
                operationName: "CreateMemoryAsync");
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::ModernMT.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::ModernMT.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "CreateMemoryAsync",
                                pathTemplate: "\"/memories\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::ModernMT.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreateMemoryResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::ModernMT.MemoryResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::ModernMT.AutoSDKHttpResponse<global::ModernMT.MemoryResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::ModernMT.MemoryResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
