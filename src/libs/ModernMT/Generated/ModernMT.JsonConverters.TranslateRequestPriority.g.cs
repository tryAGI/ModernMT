...
{
    /// <inheritdoc />
    public sealed class TranslateRequestPriorityJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::ModernMT.TranslateRequestPriority>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::ModernMT.TranslateRequestPriorityExtensions.ToValueString(value));
        }
    }
}
